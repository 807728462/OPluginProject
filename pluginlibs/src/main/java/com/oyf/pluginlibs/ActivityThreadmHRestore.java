 ...
 * @创建者 oyf
 * @创建时间 2020/4/7 10:20
 * @描述 即将要加载的时候，需要把ProxyActivity 给 换回来，换成目标LoginActivity，我们也称为【还原操作】
 **/
public class ActivityThreadmHRestore {
    /**
     * 注意：此方法 适用于 21以下的版本 以及 21_22_23_24_25  26_27_28 等系统版本
     *
     * @param mContext
     * @throws Exception
     */
        ...
        public boolean handleMessage(Message msg) {
            if (Parameter.EXECUTE_TRANSACTION == msg.what) {
                ...
                try {
                    ...
                    Log.d("hook", "proxyIntent3:" + proxyIntent);
                    Intent targetIntent = proxyIntent.getParcelableExtra(Parameter.TARGET_INTENT_KEY);
            ...
            } else if (msg.what == Parameter.LAUNCH_ACTIVITY) {
                try {
                    Object obj = msg.obj;
    ...
    /**
     * 专门给 21_22_23_24_25 系统版本 做【还原操作】的
     */
